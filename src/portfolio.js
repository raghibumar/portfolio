...
export const main = {
  ...
  resume:
    "https://drive.google.com/file/d/1NAuniVR4SrVYaKxoCang7P4N32EOhJif/view?usp=sharing",
};
...
export const whatido = {
  ...
  details: [
    "Building responsive website using React",
...
export const details = [
  {
    id: 1,
    title: "Clone of Juicy Chemistry",
    ...
    deploy: "http://juicy-chemistry.vercel.app/",
  },
  {
    id: 2,
    title: "Clone of The Bowl Company",
    desc: "The bowl company is the a online food Delivery website, from where you can buy a various types of food items in a special bowl. The speciallity of this website is food deliveries deliver in a special bowl.",
  ...
  },
  {
    ...
    desc: "The Home Depot, is the largest home improvement retailer in the United States, supplying tools,construction products, appliances and services. The company is headquartered in incorporated Cobb County, Georgia.",
    img: "https://i.imgur.com/bXzyT9C.png",
    link: "https://drive.google.com/file/d/1k4Hr-jdb8nQvdhcZD_0V1i17nNKkv5k6/view?usp=sharing",
    github: "https://github.com/Shyamal90/homeDepot_clone",
    deploy: "https://shyamal90.github.io/homeDepot_clone/",
  },
  {
    id: 4,
    title: "Clone of Mytheresa",
    desc: "Mytheresa is an online shopping destination for children, men and women's luxury clothing, bags,shoes, and accessories.",
    img: "https://i.imgur.com/BiaYLHt.png",
    link: "https://drive.google.com/file/d/1gwGpu4VCfKivn6t11R062QSUx9AUuuXg/view?usp=sharing",
