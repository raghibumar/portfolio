...
export const details = [
  {
    ...
    desc: "Built a user friendly sign-up and sign-in page, Designed responsive layouts for various pages, Worked on the product page, Responsible for pushing code to GitHub.",
